...
export function SubmitButton({ loading, children }: SubmitButtonProps) {
  return (
    <button
      type="submit"
      className="group relative mt-4 h-14 w-full cursor-pointer overflow-hidden rounded-lg bg-gradient-to-r from-[#704a94] to-[#5b038a] font-medium text-white shadow-lg transition-all hover:shadow-xl active:scale-95"
      disabled={loading}
    >
